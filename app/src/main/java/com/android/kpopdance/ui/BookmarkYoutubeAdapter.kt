...
class BookmarkYoutubeAdapter : RecyclerView.Adapter<BookmarkYoutubeAdapter.ViewHolder>()  {
    var youtubes = mutableListOf<Youtube>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.bookmark_youtube_item, parent, false)
